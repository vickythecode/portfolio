  ...
  return (
    <section id="intro">
        <div className="introContent">
            ...
            <a href='https://drive.google.com/file/d/10s_rE_Rej7p7DGndzruretggZ5q8h8j-/view?usp=drive_link' target='_blank'><button className="btn1">Hire Me <FontAwesomeIcon icon={faBriefcase} /></button></a>
