  ...
  return (
    <section id="intro">
        <div className="introContent">
            ...
            <Link><button className="btn1">Hire Me <FontAwesomeIcon icon={faBriefcase} /></button></Link>
            <Link><button className="btn2">Projects <FontAwesomeIcon icon={faCode} /> </button></Link>
            </div>
