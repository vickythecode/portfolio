  ...
  return (
    <section id="intro">
        <div className="introContent">
            ...
            <a href='https://drive.google.com/file/d/1i0u6YGtBSo60QpbH2UdrYHTv13ezgul6/view' target='_blank'><button className="btn1">Hire Me <FontAwesomeIcon icon={faBriefcase} /></button></a>
